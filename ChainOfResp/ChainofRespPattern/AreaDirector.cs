    ...
    public class AreaDirector : Employee
    {
        ...
        public override void ProcessRequest(CustomerViewModel customerViewModel)
        {
            if (customerViewModel.Amount <= 360000)
            {
                ...
                customerProcess.EmployeName = "Talha Yıldız";
                customerProcess.Description = "Talep ettiğiniz tutar bölge müdürü tarafından ödendi";
            ...
            else
            {
                ...
                customerProcess.Amount = customerViewModel.Amount;
                customerProcess.EmployeName = "Talha Yıldız";
                customerProcess.Description = "Talep ettiğiniz tutar bölge müdürü tarafından ödenemedi işlem gerçekleştirilemedi";
                _context.CustomerProcesses.Add(customerProcess);
              _context.SaveChanges();
